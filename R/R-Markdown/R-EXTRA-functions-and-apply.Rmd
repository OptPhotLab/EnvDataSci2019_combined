...
Read the ET data file from https://github.com/OptPhotLab/EnvDataSci2019_combined/tree/master/R/data  


```{r}
# hint, take a look in notebook R2-databasics  

```

read the T (or gpp) file, and combine the two files together into a single dataframe:
```{r}
